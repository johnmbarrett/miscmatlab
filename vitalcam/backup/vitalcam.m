...
handles.liveStream = axes;
handles.cam = cv.VideoCapture(0);
pause(3);
assert(handles.cam.isOpened(),'Camera failed to open');
% END USER CODE
...
frame = handles.cam.read;
image(handles.liveStream,frame);
% END USER CODE
